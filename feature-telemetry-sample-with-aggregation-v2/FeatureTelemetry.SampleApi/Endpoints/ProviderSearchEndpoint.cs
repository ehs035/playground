...
public sealed class ProviderSearchEndpoint : TelemetryEndpoint<ProviderSearchRequest, ProviderSearchResponse>
{
    ...
    protected override Task OnBeforeHandleAsync(ProviderSearchRequest req, CancellationToken ct)
    {
        _providerSearchService = Resolve<IProviderSearchService>();
        return Task.CompletedTask;
    }

    protected override async Task<ProviderSearchResponse> ExecuteFeatureAsync(
        ProviderSearchRequest req,
