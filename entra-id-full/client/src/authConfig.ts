...
export const msalConfig: Configuration = {
  auth: {
    ...
    redirectUri: "https://localhost:3000/" ?? window.location.origin,
...
export const loginRequest = {
  scopes: [import.meta.env.VITE_API_SCOPE ?? 'https://deviehporg.onmicrosoft.com/3dcd5b92-d5ff-4b7f-913e-a23125ba5b2c/Dashboard.Read'],
}

export const apiConfig = {
  baseUrl: import.meta.env.VITE_API_BASE ?? 'https://localhost:5000',
